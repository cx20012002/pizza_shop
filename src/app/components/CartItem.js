        ...
        <div className={"select-none"}>
            <div className={"flex gap-x-4 mb-2"}>
                ...
                <div className={"flex justify-center items-center"}>
                    <Image src={pizza.image} alt={'pizza'} width={90} height={90} priority/>
                </div>
                {/* pizza info */}
                <div className={"flex-1 flex flex-col gap-y-1"}>
                    ...
                    <div className={"flex flex-col gap-y-1"}>
                        ...
                        <div className={"flex items-center gap-x-1"}>
                            ...
                            {/*  pizza amount */}
                            <div
                                className={"font-semibold flex flex-1 max-w-[30px] justify-center items-center text-sm"}>
                                {pizza.amount}
                            </div>
                            {/* increase quantity */}
                            <div
                ...
                <div className={"flex flex-col justify-between"}>
                    {/* remove item */}
                    <div
                        onClick={() => removeItem(pizza.id, pizza.price, pizza.size, pizza.additionalTopping, pizza.crust)}
            ...
            <div className={"flex flex-wrap items-center gap-3 p-6 border-b border-black/10"}>
                ...
                {pizza.additionalTopping.map((topping, index) => {
                    return (
                        <div className={"capitalize text-sm gradient font-medium px-3 py-1 rounded-full leading-none"}

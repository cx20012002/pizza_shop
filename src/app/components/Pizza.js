...
const Pizza = ({pizza}) => {
    ...
    return (
        <div className={"group py-2 px-4 xl:py-4 xl:px-2 rounded-xl"}>
            ...
            <div className={"text-sm font-medium mix-h-[60px] mb-6"}>{pizza.description}</div>
            ...
            {modal && (
                <Modal
                    ...
                    className="bg-white w-full h-full lg:max-w-[900px] lg:max-h-[600px] lg:rounded-[30px] lg:fixed
                     lg:top-[50%] lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[-50%] outline-none"
                >
                    <div
                        onClick={closeModal}

        ...
        <>
            {cart.length >= 1 ? (
                <div className={"px-6 py-3 lg:py-6 mt-auto"}>
                    <div
                        className={"flex items-center justify-between mb-6 text-lg font-semibold font-robotoCondensed"}>
                        <div>Total:</div>
                    ...
                    <div className={"flex flex-col gap-y-3"}>
                        <button onClick={() => {
                            setIsOpen(false);
                            openModal(true)
                        }} className={"btn btn-lg gradient font-semibold flex justify-center"}>Checkout
                        </button>
                    </div>
                </div>
            ) : (
            ...
            {/*  checkout modal  */}
            {
                modal && (
                    ...
                    >
                        ...
                        <div
                            onClick={closeModal}
                            className={"absolute z-30 right-2 top-2 hover:scale-110 duration-200 transition-all cursor-pointer"}
                        >
